...
export const readSpecsTool: ToolDefinition = {
	...
	execute: async (params, context?: ToolContext) => {
		try {
			...
			// Get the default agent to find its pubkey
			...
			const defaultPubkey = defaultAgent.getPubkey();

			// Build filter for NDKArticle events from default agent
