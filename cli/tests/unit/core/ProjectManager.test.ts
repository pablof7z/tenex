...
describe("ProjectManager", () => {
    ...
    beforeEach(async () => {
        ...
        mockProjectServiceInstance.createProjectStructure.mockImplementation(() => Promise.resolve());
    ...
    describe("initializeProject", () => {
        test("should initialize a new project successfully", async () => {
            ...
            const result = await projectManager.initializeProject(projectPath, naddr, mockNDK as any);
        ...
        test("should handle errors gracefully", async () => {
            ...
            await expect(projectManager.initializeProject(projectPath, naddr, mockNDK as any)).rejects.toThrow(
                "Network error"
            );
        });
    });
    ...
    describe("ensureProjectExists", () => {
        ...
        test("should initialize new project if it doesn't exist", async () => {
            ...
            const result = await projectManager.ensureProjectExists(identifier, naddr, mockNDK as any);
