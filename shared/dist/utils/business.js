...
export const StringUtils = {
     ...
     */
    getFirstLine(content, maxLength) {
...
export class LocalStorageUtils {
     ...
     */
    static createSeenTracker(storageKey) {
        return {
            /**
            ...
            getAllSeen() {
                try {
                    const seen = JSON.parse(localStorage.getItem(storageKey) || "{}");
                    return Object.keys(seen).filter((key) => seen[key]);
                }
                catch {
                    return [];
                }
     ...
     */
    static createSecureStorage(storageKey) {
        return {
            get() {
     ...
     */
    static createPreferencesStorage(storageKey, defaults) {
        return {
            get() {
                try {
...
export const ProfileUtils = {
     ...
     */
    getDisplayName(profile, pubkey, fallback = "Anonymous") {
...
export const ValidationRules = {
    ...
    url: (message = "Must be a valid URL") => (value) => {
        const str = String(value || "");
