import type { AgentConfig, AgentsJson } from "@tenex/types/agents";
...
/**
 * Creates a mock agents.json structure
 */
export function createMockAgentsJson(
    agents: Record<string, { nsec: string; file?: string }> = {}
): AgentsJson {
    return {
