...
Respond in JSON format:
{
  ...
  "reasoning": "Brief explanation of your decision"
    ...
    private buildSystemPrompt(): string {
        const persona =
            this.options.userPersona || "a software developer looking to build a new project";

        const goal = this.options.conversationGoal || "brainstorm and plan a new software project";
