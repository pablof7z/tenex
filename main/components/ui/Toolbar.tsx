                ...
                <div className="relative flex space-x-[6px] items-center">
                    {tabs.map(([label, onClick], index) => (
                        <button
                            ...
                            className={`px-3 py-2 cursor-pointer transition-colors duration-300 h-[30px] flex items-center justify-center appearance-none bg-transparent border-none ${
                                // Added button resets
                                index === activeIndex
