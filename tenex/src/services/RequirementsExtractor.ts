...
export class RequirementsExtractor {
    private static readonly EXTRACTION_PROMPT =
        `You are a requirements analyst. Your task is to extract project requirements from a conversation between a user and a project manager.
            ...
            const chatEvents = conversation.history
                ...
                .filter((event) => {
                    ...
                    return (
                        ...
                        event.tags.some((tag) => tag[0] === "agent" && tag[1] === "project")
                    );
                });
