 ...
 */
export interface TypedMCPTool<TInput extends z.ZodType<any>> extends EffectTool<z.infer<TInput>, any> {
 ...
 */
export function createTypedMCPTool<TInput extends z.ZodType<any>>(
  config: {
    name: string;
    serverName: string;
    description?: string;
