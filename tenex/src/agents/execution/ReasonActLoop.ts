...
export class ReasonActLoop {
  ...
  async *executeStreaming(
    ...
    try {
      ...
      if ((context.nextAgent || phaseTransitionMetadata) && finalResponse && context.eventToReply) {
        try {
          await publishAgentResponse(
            context.eventToReply,
            fullContent,
            ...
            phaseTransitionMetadata ? [["phase", phaseTransitionMetadata.phaseTransition.to]] : []
          );
