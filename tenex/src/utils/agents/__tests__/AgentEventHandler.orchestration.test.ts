...
describe("AgentEventHandler with Orchestration", () => {
    ...
    describe("handleChatEvent", () => {
        it("should use orchestration for new conversations without p-tags", async () => {
            ...
            await handler.handleChatEvent(event, mockNDK);
            ...
            // Verify only team members generated responses
            expect(agents.get("code")!.generateResponse).toHaveBeenCalled();
            expect(agents.get("planner")!.generateResponse).toHaveBeenCalled();
            expect(agents.get("debugger")!.generateResponse).not.toHaveBeenCalled();
        });
        ...
        it("should skip orchestration when p-tags are present", async () => {
            ...
            await handler.handleChatEvent(event, mockNDK, "code", undefined, ["debuggerpubkey"]);
        ...
        it("should use existing team for ongoing conversations", async () => {
            ...
            // Verify only existing team members responded
            expect(agents.get("code")!.generateResponse).toHaveBeenCalled();
            expect(agents.get("planner")!.generateResponse).toHaveBeenCalled();
            expect(agents.get("debugger")!.generateResponse).not.toHaveBeenCalled();
        });
        ...
        it("should use orchestration for new tasks", async () => {
            ...
            const mockTeam: Team = {
                ...
                taskDefinition: {
                    ...
                    complexity: 7,
                    requiredCapabilities: ["testing", "code-review"],
                },
                formation: {
            ...
            await handler.handleTaskEvent(event, mockNDK);
            ...
            // Verify only team members responded
            expect(agents.get("debugger")!.generateResponse).toHaveBeenCalled();
            expect(agents.get("code")!.generateResponse).toHaveBeenCalled();
            expect(agents.get("planner")!.generateResponse).not.toHaveBeenCalled();
        });
