...
export class SystemPromptBuilder {
    ...
    public buildSections(context: SystemPromptContext): PromptSection[] {
        ...
        // If agent has a predefined system prompt, use it as the base
        if (context.agentConfig.systemPrompt) {
            sections.push({
                id: "predefined",
                name: "Predefined System Prompt",
                priority: 1000, // Highest priority so it comes first
        ...
        if (
            ...
            workingBuilders.set("project-specs", new ProjectSpecsBuilder(context.specCache));
        }
     ...
     */
    public withConfig(config: Partial<SystemPromptBuilderConfig>): SystemPromptBuilder {
