...
export const addTaskTool: ToolDefinition = {
    name: "add_task",
    description:
        "CREATE a task without implementing it. This tool only publishes a task description for others to work on later - it does NOT write any code or make changes. Use this tool for planning and task management, not for actual implementation.",
    parameters: [
        {
            name: "title",
            type: "string",
