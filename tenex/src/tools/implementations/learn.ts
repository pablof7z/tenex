  ...
  parameters: [
    {
      ...
      type: "string",
      description:
        "Brief title/description of what this lesson is about (e.g., 'Async iteration in TypeScript', 'Git rebase workflow')",
      required: true,
    },
    {
      name: "lesson",
      type: "string",
      description:
        "The key insight or lesson learned. Include: what went wrong (if applicable), the key insight that fixed it, and the correct approach. Keep it concise (max 3-5 sentences).",
      required: true,
    },
    {
      name: "keywords",
      type: "array",
      description:
        "Keywords to help retrieve this lesson later (e.g., ['typescript', 'async', 'promises'] or ['git', 'rebase', 'conflict'])",
      required: false,
      items: {
        name: "keyword",
        type: "string",
