...
`,
  ...
  parameters: createZodSchema(
    z.object({
      ...
      messageToAgents: z.string().describe("The message that agents will see. This MUST include what the agent(s) NEED TO DO and what they NEED TO KNOW. Be specific and clear, as this is the ONLY message agents will receive.")
    })
  ),
