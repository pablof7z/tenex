...
import type { OpenRouterResponse, OpenAIToolCall } from "@/llm/types/responses";
...
export class OpenRouterProvider extends BaseLLMProvider {
  ...
  protected extractUsage(data: OpenRouterResponse): { prompt_tokens?: number; completion_tokens?: number } | null {
    return data.usage
      ? {
          prompt_tokens: data.usage.prompt_tokens,
          completion_tokens: data.usage.completion_tokens,
  ...
  protected extractToolCallData(toolCall: OpenAIToolCall): { name: string; arguments: Record<string, unknown> } | null {
