...
export class ToolCallParser {
    ...
    static parseOpenRouterToolCall(toolCall: any): ParsedToolCall | null {
        try {
    ...
    static parseOllamaToolCall(toolCall: any): ParsedToolCall | null {
        try {
    ...
    private static parseArguments(args: string | any): any {
