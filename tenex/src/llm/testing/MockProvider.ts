...
export class MockLLMProvider extends BaseLLMProvider {
  ...
  protected extractToolCallData(toolCall: unknown): { name: string; arguments: Record<string, unknown> } | null {
  ...
  protected extractUsage(data: unknown): { prompt_tokens?: number; completion_tokens?: number } | null {
    if (data.usage) {
