...
export function isOpenAIResponse(response: any): response is OpenAIResponse {
    return (
        response &&
...
export function isOpenRouterResponse(response: any): response is OpenRouterResponse {
    return (
...
export function isOllamaResponse(response: any): response is OllamaResponse {
    return (
        response &&
...
export function isAnthropicToolContent(
    content: AnthropicContent
): content is AnthropicContent & { name: string; input: any; id: string } {
    return (
...
export function extractToolCalls(response: ProviderResponse): any[] {
    if (isAnthropicResponse(response)) {
