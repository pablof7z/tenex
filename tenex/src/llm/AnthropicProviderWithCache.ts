...
export class AnthropicProviderWithCache extends AnthropicProvider {
    ...
    protected override parseResponse(data: unknown): LLMResponse {
        ...
        if (dataWithUsage.usage && baseResponse.usage) {
            baseResponse.usage = {
                ...baseResponse.usage,
                cache_creation_input_tokens: dataWithUsage.usage.cache_creation_input_tokens,
                cache_read_input_tokens: dataWithUsage.usage.cache_read_input_tokens,
            };
        }
