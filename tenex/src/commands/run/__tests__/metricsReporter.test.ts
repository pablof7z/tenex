...
describe("MetricsReporter", () => {
    ...
    describe("start", () => {
        it("should set up initial timeout and interval", () => {
            ...
            expect(logger.debug).toHaveBeenCalledWith("📊 Metrics reporter started", {
                intervalMinutes: 30,
            });
        });
        ...
        it("should report metrics after initial timeout", () => {
            mockProjectContext.getAllLessons.mockReturnValue([{ id: "1", title: "Test lesson" }]);
    ...
    describe("reportMetrics", () => {
        ...
        it("should handle errors during reporting", () => {
            ...
            expect(logger.error).toHaveBeenCalledWith("Failed to report metrics", {
