    ...
    for (const modelId of modelsToTest) {
        ...
        try {
            ...
            const messages = [
                new Message(
                    "system",
                    "You are a helpful assistant. Use the available tools to answer questions. When asked about weather, use get_weather. When asked to calculate, use calculator."
                ),
                new Message(
                    "user",
                    "What is the weather in San Francisco? Also, what is 42 multiplied by 17?"
                ),
            ];
