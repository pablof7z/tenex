...
def create_clean_xcode_project():
    ...
    if os.path.exists("TENEXiOS.xcodeproj"):
        shutil.rmtree("TENEXiOS.xcodeproj")
...
"""
    ...
    os.makedirs("TENEXiOS.xcodeproj/xcshareddata/xcschemes", exist_ok=True)
...
<Scheme
   ...
   <ArchiveAction
    ...
    with open("TENEXiOS.xcodeproj/xcshareddata/xcschemes/TENEXiOS.xcscheme", "w") as f:
        f.write(scheme_content)
    
    print("✅ Created clean Xcode project!")
    print("📦 Packages included:")
    print("   - NDKSwift (branch: master)")
    print("   - Nuke (12.0.0+)")
    print("   - NukeUI")
    print("\n⚠️  Important:")
    print("   - Project uses existing Info.plist (not auto-generated)")
    print("   - No files are included yet - you need to add them in Xcode")
    print("\n📝 Next steps:")
    print("1. Open TENEXiOS.xcodeproj in Xcode")
    print("2. Drag the TENEXiOS folder into the project navigator")
    print("3. When prompted, make sure:")
    print("   - 'Copy items if needed' is UNCHECKED")
    print("   - 'Create groups' is selected")
    print("   - 'TENEXiOS' target is selected")
    print("4. Set your Development Team in Signing & Capabilities")
